...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Blog Post Not Found | Real Estate' }
  }
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  {(item as any).postCategory && (
                    <div>
                      <dt className="text-sm text-gray-500">Post Category</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).postCategory}</dd>
                    </div>
                  )}
                </dl>
                <div className="mt-8">
